...
Hello, and thanks for contributing to ember-cli-imgix! 🎉🙌
...
4.  Ensure the test suite passes (`yarn run test`). Tip: `yarn run --watch` is helpful in development.
5.  Format your code with [prettier](https://github.com/prettier/prettier) (`yarn run format`). Don't worry too much if you haven't done this, we have a bot that will do this for you when you submit a PR.
